<script setup>
useHead({
    title: '搜据屋 - 电视直播与 Alist 数据源聚合播放',
    meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1, shrink-to-fit=no' },
        { name: 'keywords', content: '搜据屋, 电视直播, Alist 数据源, 聚合播放, 在线电视' },
        { hid: 'description', name: 'description', content: '搜据屋提供最新的电视直播和 Alist 数据源聚合播放，轻松享受精彩内容！' },
        { name: 'author', content: '搜据屋团队' },
        ...
        { name: 'twitter:description', content: '搜据屋提供最新的电视直播和 Alist 数据源聚合播放，轻松享受精彩内容！' },
